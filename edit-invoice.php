            ...
            <div class="content-area">
                ...
                <div class="invoice-form">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
                        <h2><i class="fas fa-file-invoice"></i> Invoice #<?php echo htmlspecialchars($invoice['invoice_number']); ?></h2>
                        <div style="display: flex; gap: 10px;">
                            <a href="invoices.php" class="btn" style="background: var(--border-color);">
                                <i class="fas fa-arrow-left"></i> Back
                            </a>
                            <a href="invoice-template.php?id=<?php echo $invoiceId; ?>" target="_blank" class="btn btn-secondary">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" value="<?php echo $invoice['invoice_date']; ?>" readonly style="background-color: #f0f0f0;">
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="paid_amount" class="form-control" value="<?php echo $invoice['paid_amount']; ?>" step="0.01" min="0">
                            </div>
                        ...
                        <div style="padding: 20px;">
                            <?php if ($invoice['balance_amount'] > 0): ?>
                                <form method="POST">
                                    ...
                                    <button type="submit" class="btn btn-primary" style="width: 100%; background: var(--success-color);">
