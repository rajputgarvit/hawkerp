...
$employees = $db->fetchAll("SELECT id, first_name, last_name FROM employees WHERE status = 'Active' ORDER BY first_name");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        header('Location: inventory-settings.php?success=Warehouse added successfully');
        exit;
    } catch (Exception $e) {
                ...
                <div class="card">
                    ...
                    <form method="POST" style="padding: 20px;">
                        ...
                        <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 20px;">
                            <a href="inventory-settings.php" class="btn" style="background: var(--border-color);">Cancel</a>
