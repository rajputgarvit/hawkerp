...
$warehouses = $db->fetchAll("SELECT * FROM warehouses ORDER BY name");
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="content-area">
                ...
                <div class="settings-grid">
                    ...
                    <div class="setting-card">
                        ...
                        <a href="create-category.php" class="btn btn-primary btn-block">
                    ...
                    <div class="setting-card">
                        ...
                        <a href="create-warehouse.php" class="btn btn-primary btn-block">
