...
$suppliers = $db->fetchAll("
    SELECT s.*, 
           ...
           (SELECT COALESCE(SUM(total_amount), 0) FROM purchase_invoices WHERE supplier_id = s.id) as total_purchases
    FROM suppliers s 
            ...
            <div class="content-area">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="create-supplier.php" class="btn btn-primary btn-sm">
