...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['add_note'])) {
    ...
    try {
        ...
        header("Location: customer-details.php?id=$customerId&success=Note added successfully");
        exit;
    } catch (Exception $e) {
        ...
        <main class="main-content">
            ...
            <div class="content-area">
                ...
                <div class="page-header">
                    <div>
                        <h1><i class="fas fa-user-tie"></i> <?php echo htmlspecialchars($customer['company_name']); ?></h1>
                        <p>Customer Code: <?php echo htmlspecialchars($customer['customer_code']); ?></p>
                    </div>
                    <div style="display: flex; gap: 10px;">
                        <a href="create-quotation.php?customer_id=<?php echo $customerId; ?>" class="btn btn-primary">
                            <i class="fas fa-file-invoice"></i> New Quotation
                        </a>
                        <a href="create-invoice.php?customer_id=<?php echo $customerId; ?>" class="btn btn-primary">
                            <i class="fas fa-receipt"></i> New Invoice
                        </a>
                        <a href="customers.php" class="btn" style="background: var(--border-color);">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 20px;">
                    ...
                    <div class="card">
                        ...
                        <div style="padding: 20px;">
                            <table style="width: 100%;">
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Contact Person:</td>
                                    <td style="padding: 8px 0;"><strong><?php echo htmlspecialchars($customer['contact_person'] ?? 'N/A'); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Email:</td>
                                    <td style="padding: 8px 0;"><strong><?php echo htmlspecialchars($customer['email'] ?? 'N/A'); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Phone:</td>
                                    <td style="padding: 8px 0;"><strong><?php echo htmlspecialchars($customer['phone'] ?? 'N/A'); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Mobile:</td>
                                    <td style="padding: 8px 0;"><strong><?php echo htmlspecialchars($customer['mobile'] ?? 'N/A'); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">GSTIN:</td>
                                    <td style="padding: 8px 0;"><strong><?php echo htmlspecialchars($customer['gstin'] ?? 'N/A'); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">PAN:</td>
                                    <td style="padding: 8px 0;"><strong><?php echo htmlspecialchars($customer['pan'] ?? 'N/A'); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Segment:</td>
                    ...
                    <div class="card">
                        ...
                        <div style="padding: 20px;">
                            ...
                            <?php else: ?>
                                <p style="color: var(--text-secondary);">No address on file</p>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-money-bill-wave"></i> Financial Info</h3>
                        </div>
                        <div style="padding: 20px;">
                            <table style="width: 100%;">
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Credit Limit:</td>
                                    <td style="padding: 8px 0; text-align: right;"><strong>₹<?php echo number_format($customer['credit_limit'], 2); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Outstanding:</td>
                                    <td style="padding: 8px 0; text-align: right;"><strong style="color: var(--danger-color);">₹<?php echo number_format($customer['current_outstanding'], 2); ?></strong></td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Utilization:</td>
                                    <td style="padding: 8px 0; text-align: right;">
                                        <strong style="color: <?php echo $creditUtilization > 80 ? 'var(--danger-color)' : 'var(--success-color)'; ?>;">
                                            <?php echo $creditUtilization; ?>%
                                        </strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 8px 0; color: var(--text-secondary);">Payment Terms:</td>
                                    <td style="padding: 8px 0; text-align: right;"><strong><?php echo $customer['payment_terms']; ?> days</strong></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="stats-grid" style="margin-bottom: 30px;">
                    ...
                    <div class="stat-card">
                        <div class="stat-card-header">
                            <div>
                                <div class="stat-value">₹<?php echo number_format($customer['avg_order_value'], 2); ?></div>
                    ...
                    <div class="stat-card">
                        <div class="stat-card-header">
                            <div>
                                <div class="stat-value"><?php echo $customer['last_order_date'] ? date('d M Y', strtotime($customer['last_order_date'])) : 'Never'; ?></div>
                                    ...
                                    <tbody>
                                        <?php foreach ($invoices as $invoice): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-invoice.php?id=<?php echo $invoice['id']; ?>" class="btn btn-sm">
                                    ...
                                    <tbody>
                                        <?php foreach ($quotations as $quotation): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit-quotation.php?id=<?php echo $quotation['id']; ?>" class="btn btn-sm">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
