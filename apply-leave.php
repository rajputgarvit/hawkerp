...
$leaveTypes = $db->fetchAll("SELECT * FROM leave_types WHERE is_active = 1 ORDER BY name");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($totalDays < 0.5) {
        ...
        try {
            ...
            header('Location: leaves.php?success=Leave application submitted successfully');
            exit;
        } catch (Exception $e) {
                ...
                <div class="card">
                    ...
                    <form method="POST" style="padding: 20px;">
                        ...
                        <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 20px;">
                            <a href="leaves.php" class="btn" style="background: var(--border-color);">Cancel</a>
