...
$employees = $db->fetchAll("SELECT id, employee_code, first_name, last_name FROM employees WHERE status = 'Active' ORDER BY first_name");
                ...
                <div class="card">
                    ...
                    <form method="POST" style="padding: 20px;">
                        ...
                        <div style="display: flex; gap: 10px; justify-content: flex-end; margin-top: 20px;">
                            <a href="attendance.php" class="btn" style="background: var(--border-color);">Cancel</a>
