...
// Build WHERE clause
$whereConditions = ["i.status IN ('Sent', 'Partially Paid', 'Overdue')"];
$params = [];
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div style="display: flex; gap: 5px;">
                                                    <a href="record-payment.php?invoice_id=<?php echo $invoice['id']; ?>" class="btn btn-sm" style="background: var(--success-color); color: white;" title="Record Payment">
                                                        <i class="fas fa-money-bill"></i>
                                                    </a>
                                                    <a href="edit-invoice.php?id=<?php echo $invoice['id']; ?>" class="btn btn-sm" title="View Invoice">
